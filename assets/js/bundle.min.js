  ...
  (((x = jQuery).fn.html5lightbox = function (t) {
    ...
    ((w.options.canplaymp4 =
          ...
          w.options.inGroup &&
            ...
            x(".html5-pause", w.$lightbox).click(function () {
              (x(".html5-play", w.$lightbox).show(),
                x(".html5-pause", w.$lightbox).hide(),
                w.slideTimeout &&
                  (w.slideTimeout.stop(), (w.autosliding = !1)));
            })),
      ...
      (w.resizeLightbox = function (t, e, i, o, n) {
        ...
        (w.options.fullscreenmode &&
          w.options.fullscreennotransition &&
          (i = 0),
          ("slide" == w.options.transition ||
            "crossfade" == w.options.transition) &&
            0 <= w.existingElem &&
            ...
            ? (w.$prevelem.animate(
              ...
              w.$elem.animate(
                ...
                },
                {
                  ...
                  always: function () {
                    (w.$prevelem.remove(),
                      w.$elem.removeClass("html5-elem-box-current").css({
                        position: "relative",
                        height: "100%",
                      }));
                  },
      ...
      w.each(function () {
        ...
        ("undefined" != typeof html5lightbox_options &&
          ...
          (s = t.data("autoopenonceexpire")
            ? t.data("autoopenonceexpire")
            : s));
...
(!(function (t, e) {
              ...
              return (
                ...
                ht(function (t, e, i, o) {
                  ...
                  if (t) {
                    ...
                    ((p = bt(p === e ? p.splice(h, p.length) : p)),
                      v ? v(null, e, p, o) : j.apply(e, p));
                })
              );
            })(
              1 < a && _t(c),
  ...
  (((S.fn.init = function (t, e, i) {
    ...
    return (
      (t = k.getElementById(o[2])) && ((this[0] = t), (this.length = 1)),
      this
    );
  }).prototype = S.fn),
    (O = S(k)));
    ...
    special: {
      ...
      click: {
        ...
        trigger: function (t) {
          t = this || t;
          return (
            ct.test(t.type) && t.click && E(t, "input") && St(t, "click"),
            !0
          );
        },
        _default: function (t) {
  ...
  (S.extend({
    ...
    clone: function (t, e, i) {
      ...
      return (
        0 < (r = ft(c, "script")).length && mt(r, !u && ft(t, "script")),
        c
      );
    },
    ...
    var B = "tooltip",
      ...
      K =
        ...
        (mt.getTipElement = function () {
          return (
            (this.tip = this.tip || c(this.config.template)[0]),
            this.tip
          );
        }),
...
((_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
      ...
      function (s, O) {
        ...
        var Et,
          ...
          jt = (o.Transform = function () {
            ((this.perspective =
              parseFloat(D.defaultTransformPerspective) || 0),
              (this.force3D =
  ...
  (function (p, d) {
    ...
    if (!g.TweenLite) {
      ...
      ((C.linear = u.easing.Linear.easeIn),
        (C.swing = u.easing.Quad.easeInOut));
